...
function posts_list_activate(){
    // Register shortcode
    add_shortcode('posts-list', 'posts_list_shortcode');
}
register_activation_hook(__FILE__, 'posts_list_activate');

//On plugin deactivation
function posts_list_deactivate(){
    remove_shortcode('posts-list');
}
register_deactivation_hook(__FILE__, 'posts_list_activate');
